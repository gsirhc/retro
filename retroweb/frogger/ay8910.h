// General Instrument AY-3-8910 PSG — the sound chip on Konami Frogger (1981).
//
...
// general-purpose; Frogger reads the sound-command latch on port A. Volume
// is the documented 16-level logarithmic DAC. Envelope and mixer follow the
// AY-3-8910 datasheet; MAME ay8910.cpp is a cross-check of the envelope
// shapes, not a behavior source.

#ifndef FROGGER_AY8910_H
#define FROGGER_AY8910_H
