...
const CHIP_RE = /(?:^|[._-])(6e|6f|6h|6j|5e|5f|7f|4a|1m)(?:[^a-z0-9]|$)/i;
const IGNORE_RE = /(?:^|[._-])3m(?:[^a-z0-9]|$)/i;
const SIZE = { program: 0x4000, bank: 0x1000, tiles: 0x1000, sprites: 0x1000, color: 0x20, lookup: 0x100, wave: 0x100 };
...
function identifySet(files, hwtestCrcs) {
  ...
  return { kind, program, tiles, sprites, color, lookup, wave };
}
