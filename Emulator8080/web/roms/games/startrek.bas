...
193 REM ***
200 REM *** ADAPTED TO MSBASIC V5.0+ INTEGER ROUNDING ON 18/8/18
201 REM *** TOO LONG LINES (>72 CHR) SHORTENED ON 17/9/21
202 REM *** BY FEILIPU
203 REM ***
...
1250 PRINT"   THE GALAXY BEFORE THEY CAN ATTACK FEDERATION";
1251 PRINT" HEADQUARTERS"
...
1560 PRINT TAB(3);CHR$(27);"[7m";
1561 PRINT"  COMBAT AREA      CONDITION RED  ";CHR$(27);"[0m"
1562 IF S>200 THEN PRINT:GOTO 1590
1580 PRINT TAB(3);CHR$(27);"[7m";
1581 PRINT"      SHIELDS DANGEROUSLY LOW     ";CHR$(27);"[0m"
1582 PRINT
...
2020 PRINT:PRINT TAB(10);CHR$(27);"[7m";
2021 PRINT"** FATAL ERROR **";CHR$(27);"[0m"
...
2310 IF C1>=0.5 AND C1<8.5 THEN 2350
...
4480 H=INT((H1/RND(0))*(RND(1)+2)):IF H>.15*K(I,3)THEN 4530
...
4551 PRINT CHR$(27);"[7m";
4552 PRINT"*** KLINGON DESTROYED ***";CHR$(27);"[0m"
4553 PRINT:GOTO 4580
...
4780 IF C1>=0.5 AND C1<8.5 THEN 4850
...
5110 PRINT:PRINT CHR$(27);"[7m";
5111 PRINT"*** KLINGON DESTROYED ***";CHR$(27);"[0m"
5112 PRINT:K3=K3-1:K9=K9-1:IF K9<=0 THEN 6370
...
5330 PRINT CHR$(27);"[7m";"*** STARBASE DESTROYED ***";CHR$(27);"[0m"
