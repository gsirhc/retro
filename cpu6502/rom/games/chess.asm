...
;
; CHRIS G - Changed to work with my setup
;
; page zero variables
;
BOARD   =	$50 
...
OVL:		BMI	ILL             ; RETURN
		...
		PLP	
		BVC	LINE          	; NOT A CAP
ILL:		JSR	RESET_CHESS         	; LINE STOPPED
		DEC	MOVEN         	; NEXT DIR
		RTS	
;		
...
;		
RESET_CHESS:		LDX	PIECE      	; GET LOGAT
...
syshexout:      PHA                     ;  prints AA hex digits
               ...
               JSR   PrintDig          ;
               PLA                     ;
PrintDig:       PHA                     ;  prints A hex nibble (low 4 bits)
               TXA
               PHA
               AND   #$0F              ;
               TAY                     ;
