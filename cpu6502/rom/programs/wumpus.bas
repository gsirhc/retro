...
0410 GOSUB 2500
0420 IF O=1 THEN 440
0425 IF O=2 THEN 480
0430 REM-SHOOT
0440 GOSUB 3000
...
2051   IF J=2 THEN 2060
2052   IF J=3 THEN 2080
2053   IF J=4 THEN 2080
2054   IF J=5 THEN 2100
2055   IF J=6 THEN 2100
