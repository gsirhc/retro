...
LOCAL_MEM_BYTE1  = $00 + 1  ; Mem to use for local storage
LOCAL_MEM_BYTE2  = $00 + 2  ; Mem to use for local storage
PROMPT_CHAR_CNT  = $00 + 3  ; max command prompt length is 256
PROGRAM_PRT      = $00 + 4  ; 2 Bytes 
